# The name of this view in Looker is "Data Fusion Output"
view: data_fusion_output {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `batch_use_case_staging.data_fusion_output`
    ;;
  ...
  dimension: code_gender_encode_hex {
    type: string
    sql: ${TABLE}.CODE_GENDER_encode_hex ;;
  }
